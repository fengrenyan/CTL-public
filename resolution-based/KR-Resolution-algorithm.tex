...
\begin{abstract}
This paper present a resolution-based method for computing the forgetting in \CTL\, which has been proposed in another paper for KR this year.
...
We are useing binary bisimulation relation to relate \CTL\ and $\CTLsnf$, this show that how transform the \CTL\ formula into $\CTLsnf$ clauses and then return to \CTL\ formula after finish the computing process.
Besides, we extend the original resolution rules by adding EF imply rules.
