...
This show that we can use our method talked in this paper to solve similar problems in planning problem, such as  subtracting the out-of-date information and computing the WSC when there is no plan to satisfy the planning problem.
